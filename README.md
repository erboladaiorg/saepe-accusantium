# @erboladaiorg/saepe-accusantium.js #

[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/%3C%2F%3E-TypeScript-%230074c1.svg)](http://www.typescriptlang.org/)
[![Socket Badge](https://socket.dev/api/badge/npm/package/@erboladaiorg/saepe-accusantium)](https://socket.dev/npm/package/@erboladaiorg/saepe-accusantium)
[![jsdelivr](https://data.jsdelivr.com/v1/package/npm/@erboladaiorg/saepe-accusantium/badge)](https://www.jsdelivr.com/package/npm/@erboladaiorg/saepe-accusantium)
[![npm](https://img.shields.io/npm/v/@erboladaiorg/saepe-accusantium.svg?logo=npm&logoColor=fff&label=npm)](https://www.npmjs.com/package/@erboladaiorg/saepe-accusantium)
[![npm downloads](https://img.shields.io/npm/dm/@erboladaiorg/saepe-accusantium.svg?style=flat-square)](https://www.npmjs.com/package/@erboladaiorg/saepe-accusantium)
[![yarn](https://img.shields.io/npm/v/@erboladaiorg/saepe-accusantium.svg?logo=yarn&logoColor=fff&label=yarn)](https://yarnpkg.com/package?name=@erboladaiorg/saepe-accusantium)
...
See the [@erboladaiorg/saepe-accusantium.js demo](https://codepen.io/mitera/pen/XWGpLRL).

[![@erboladaiorg/saepe-accusantium.js screenshot](https://github.com/erboladaiorg/saepe-accusantium/blob/master/@erboladaiorg/saepe-accusantium.jpg)](https://github.com/erboladaiorg/saepe-accusantium/archive/refs/heads/master.zip)
...
CDN via jsDelivr
    ...
    <script src="https://cdn.jsdelivr.net/npm/@erboladaiorg/saepe-accusantium@latest/dist/@erboladaiorg/saepe-accusantium.min.js" type="text/javascript"></script>

Download [@erboladaiorg/saepe-accusantium.js](https://github.com/erboladaiorg/saepe-accusantium/blob/master/@erboladaiorg/saepe-accusantium.js) and include the script in your HTML file:

	<script src="@erboladaiorg/saepe-accusantium.js" type="text/javascript"></script>

You can also install using the package managers [NPM](https://www.npmjs.com/package/@erboladaiorg/saepe-accusantium).

    npm install @erboladaiorg/saepe-accusantium

modular code

    import MatchHeight from '@erboladaiorg/saepe-accusantium'
...
See the included [test.html](https://github.com/erboladaiorg/saepe-accusantium/blob/master/test/test.html) for many working examples.
...
To see what's new or changed in the latest version, see the [changelog](https://github.com/erboladaiorg/saepe-accusantium/blob/master/CHANGELOG.md)

### License

@erboladaiorg/saepe-accusantium.js is licensed under [The MIT License (MIT)](http://opensource.org/licenses/MIT)
